...
static void __pyx_f_4test__main(void); /*proto*/
 ...
 * 
 * cdef void _main():             # <<<<<<<<<<<<<<
 *     ctestrand.testrandom()
 * 
 */

static void __pyx_f_4test__main(void) {
 ...
 *     _main()             # <<<<<<<<<<<<<<
 */
  __pyx_f_4test__main(); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 7, __pyx_L1_error)
 ...
 *     _main()
 */
  __pyx_codeobj_ = (PyObject*)__Pyx_PyCode_New(0, 0, 0, 0, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_test_pyx, __pyx_n_s_main_2, 6, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj_)) __PYX_ERR(0, 6, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
 ...
 *     _main()
 */
  __pyx_t_2 = __Pyx_CyFunction_New(&__pyx_mdef_4test_1main, 0, __pyx_n_s_main_2, NULL, __pyx_n_s_test, __pyx_d, ((PyObject *)__pyx_codeobj_)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 6, __pyx_L1_error)
